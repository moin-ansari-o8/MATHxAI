...
export function Navigation() {
  ...
  return (
    <div id="main-navigation" className={`fixed top-0 left-0 right-0 z-[50] bg-[#fffdf8]/60 backdrop-blur-md border-b-[3px] border-ink ${isHiddenOnMobile ? 'hidden lg:block' : ''}`}>
